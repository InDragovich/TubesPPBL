...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.MyViewHolder> {
    ...
    CustomAdapter(Activity activity, Context context, ArrayList menu_id, ArrayList menu_nama, ArrayList menu_harga, ArrayList menu_jumlah, ArrayList menu_deskripsi){
